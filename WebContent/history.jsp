	...
	<div style="width: 60%; margin-left: 20%">
		...
		<div style="width: 100%; height: 120px;">
			...
			<div style="float: left; width: 60%">
				...
				<div style="width: 40%; float: left; padding-left: 5%; padding-top: 2%;">
		...
		<div>
			...
			<div>
				...
				<table style="width: 100%">
					...
					<c:forEach items="${requestScope.packetHistory}" var="item">
						<tr>
							&nbsp;
							<td style="width: 30%;"><c:out value="${item.timeStamp}" />&nbsp;&nbsp;&nbsp;</td>
							&nbsp;
							<td style="width: 35%;"><c:out value="${item.activity}" />&nbsp;&nbsp;&nbsp;</td>
							&nbsp;
							<td style="width: 20%;"><c:out value="${item.location}" />&nbsp;&nbsp;&nbsp;</td>
						<tr>
					</c:forEach>
				</table>
			</div>
			<div class="shippingFacts">
				...
				<hr>
				<div style="width: 50%; float: right;margin-right: 5%;">
